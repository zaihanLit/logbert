...
class BERTTrainer:
    ...
    def iteration(self, epoch, data_loader, train=True):
        ...
        for i, data in data_iter:
            ...
            time_loss = torch.tensor(0, device=self.device) if not self.is_time else self.time_criterion(
            ...
            mask_loss = torch.tensor(0, device=self.device) if not self.is_logkey else self.criterion(mask_lm_output.transpose(1, 2), data["bert_label"])
